...
st.title('Correlation-Generator')
...
# print(country)
#
# st.write(f"You selected option {option} called {(option)}")
# st.write(f"You selected option {option_2} called {(option_2)}")
# st.write(f"You selected option {option_3} called {(option_3)}")
